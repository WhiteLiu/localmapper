...
{
    public:
    occupancy2d() : width_( 0 ), height_( 0 ), resolution_( 0.0 ), window_( 100 ), origin_( Eigen::Isometry3d::Identity() )
    {
        /*width_ = 1024;
        height_ = 1024;
        origin_(0,3) = -20.0;
    ...
    occupancy2d( float resolution )
      : width_( 0 ), height_( 0 ), resolution_( resolution ), window_( 100 ), origin_( Eigen::Isometry3d::Identity() )
    {
    }

    occupancy2d( const occupancy2d &rhs )
      : width_( rhs.width_ ), height_( rhs.height_ ), resolution_( rhs.resolution_ ), data_( rhs.data_ ), origin_( rhs.origin_ )
    {
    }
